...
{
    /**
     * Get the global GPS Absensi Settings
     */
    ...
    /**
     * Update the global GPS Absensi Settings
     */
    public function updateGpsSettings(Request $request)
    {
        try {
            ...
            DB::table('audit_logs')->insert([
                ...
                'description' => "Updated school GPS Absensi: Lat={$data['school_latitude']}, Lng={$data['school_longitude']}, Radius={$data['school_radius_meters']}m",
